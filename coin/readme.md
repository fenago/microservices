...
<h2>**Create a Hashing Number Generator microservice**</h2>
  ...
  ![https://github.com/fenago/microservices/blob/master/coin/mdimg/4.png](https://github.com/fenago/microservices/blob/master/coin/mdimg/4.png "Logo Title Text 1") 
  ![https://github.com/fenago/microservices/blob/master/coin/mdimg/5.png](https://github.com/fenago/microservices/blob/master/coin/mdimg/5.png "Logo Title Text 1") 
...
` 
![https://github.com/fenago/microservices/blob/master/coin/mdimg/6.png](https://github.com/fenago/microservices/blob/master/coin/mdimg/6.png "Logo Title Text 1") 
...
<h2>**Create Docker File**</h2>
Now create a text file and name it  `Dockerfile` inside your hasher project folder and add following lines
...
Once you have a docker image, you can run it using `docker run` command rnglike so -
...
<h2>**Create  worker microservice**</h2>
  ...
  ![https://github.com/fenago/microservices/blob/master/coin/mdimg/7.png](https://github.com/fenago/microservices/blob/master/coin/mdimg/7.png "Logo Title Text 1") 
  ![https://github.com/fenago/microservices/blob/master/coin/mdimg/8.png](https://github.com/fenago/microservices/blob/master/coin/mdimg/8.png "Lornggo Title Text 1") 
  ![https://github.com/fenago/microservices/blob/master/coin/mdimg/9.png](https://github.com/fenago/microservices/blob/master/coin/mdimg/9.png "Logo Title Text 1") 
...
<h2>**Create worker microservice**</h2>rng
...
<h2>**Create Docker File**</h2>
Now create a text file and name it `Dockerfile` inside your worker project folder and add following lines
